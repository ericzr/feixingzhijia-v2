import svgPaths from "./svg-mhqxeo6irb";
import imgContainer from "figma:asset/b09709e778f439f32a9febe92279437ea0d30df6.png";
import imgContainer1 from "figma:asset/e2f4960d39e1f68c9217bc5627b8988d702d7063.png";
import imgContainer2 from "figma:asset/b6d343e05612d44b97bbab494471adbf30e97f90.png";
...
function Heading2() {
  return (
    <div className="h-[22.488px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] text-nowrap top-[-0.77px] tracking-[-0.3125px]">固定翼垂直起降飞行训练场</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-0 overflow-clip top-0" data-name="Container">
      <p className="font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[17.875px] not-italic relative shrink-0 text-[#6a7282] text-[13px] text-nowrap tracking-[-0.0762px]">内蒙古自治区鄂尔多斯市东胜区...</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="absolute h-[16.508px] left-0 top-[32.01px] w-[217.152px]" data-name="Container">
...
function Frame2() {
  return (
    <div className="h-[49px] relative shrink-0 w-[263px]">
...
function Heading3() {
  return (
    <div className="h-[22.488px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] text-nowrap top-[-0.77px] tracking-[-0.3125px]">穿梭机飞行场</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="h-[22.488px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[24px] left-0 not-italic text-[#101828] text-[16px] text-nowrap top-[-0.77px] tracking-[-0.3125px]">鄂尔多斯A1飞行考场</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[410px] items-start left-0 px-[15.996px] py-0 top-[550px] w-[448px]" data-name="Container">
      <ClassCard />
      <ClassCard1 />
      <ClassCard2 />
    </div>
...
function Button() {
  return (
    <div className="h-[46.476px] relative shrink-0 w-[61.984px]" data-name="Button">
      <p className="absolute font-['Inter:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold leading-[22.5px] left-[31px] not-italic text-[#99a1af] text-[15px] text-center text-nowrap top-[11.23px] tracking-[-0.2344px] translate-x-[-50%]">班型</p>
    </div>
  );
}

function Container19() {
  return <div className="absolute bg-[#c99619] h-[3.99px] left-[22.98px] rounded-[2.49829e+07px] top-[36.49px] w-[15.996px]" data-name="Container" />;
}
...
function Button1() {
  return (
    <div className="h-[46.476px] relative shrink-0 w-[61.984px]" data-name="Button">
      <Container19 />
      <p className="absolute font-['Inter:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[22.5px] left-[31px] not-italic text-[#1d293d] text-[15px] text-center text-nowrap top-[11.23px] tracking-[-0.2344px] translate-x-[-50%]">场地</p>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="relative shrink-0 size-[19.998px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.9981 19.9981">
        <g clipPath="url(#clip0_359_924)" id="Icon">
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[19.998px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.9981 19.9981">
        <g clipPath="url(#clip0_359_912)" id="Icon">
...
export default function Component1() {
  return (
    <div className="bg-[#fefbf4] relative size-full" data-name="飞场详情-场地">
      <SchoolProfile1 />
      <Container18 />
      <SchoolProfile />
      <Container22 />
