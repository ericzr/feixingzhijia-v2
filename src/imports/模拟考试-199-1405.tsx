import svgPaths from "./svg-8uucw8bwpe";
...
function OptionCard() {
  return (
    <div className="bg-white h-[90.207px] relative rounded-[14px] shrink-0 w-full" data-name="OptionCard">
      <div aria-hidden="true" className="absolute border-[0.745px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[14px] shadow-[0px_1px_3px_0px_rgba(251,242,219,0.1),0px_1px_2px_-1px_rgba(251,242,219,0.1)]" />
...
function Container5() {
  return (
    <div className="h-[48.721px] relative shrink-0 w-full" data-name="Container">
      <Text4 />
      <p className="absolute font-['Inter:Regular','Noto_Sans_SC:Regular','Noto_Sans_KR:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[24.375px] left-[21.26px] not-italic text-[#314158] text-[15px] top-[-1.02px] tracking-[-0.2344px] w-[319px]">监视无人机、诱饵无人机、电子对抗无人机、通信中继无人机、无人战斗机以及靶机</p>
    </div>
  );
}
