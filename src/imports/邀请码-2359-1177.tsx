import svgPaths from "./svg-2mobtsnvaa";
...
function Text4() {
  return (
    <div className="h-[13.507px] relative shrink-0 w-[36.007px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[15px] left-0 not-italic text-[#92400e] text-[10px] top-[0.34px] tracking-[0.1172px]">精简题库</p>
      </div>
    </div>
  );
}
