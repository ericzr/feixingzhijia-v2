import svgPaths from "./svg-0k49t9q96x";
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[692px] items-center left-0 overflow-x-clip overflow-y-auto shadow-[0px_1px_3px_0px_rgba(251,242,219,0.1),0px_1px_2px_-1px_rgba(251,242,219,0.1)] top-[232px] w-[446px]">
      <Container14 />
      <Frame3 />
    </div>
  );
...
function Frame() {
  return (
    <div className="bg-white h-[96px] pointer-events-auto sticky top-0 w-[448px]">
      <StatusBar />
      <Header />
    </div>
  );
...
function FilterBar() {
  return (
    <div className="absolute content-stretch flex flex-col h-[76px] items-start left-0 top-[156px] w-[448px]" data-name="FilterBar">
      <Container21 />
      <Container22 />
    </div>
  );
...
function Component3() {
  return (
    <div className="absolute h-[232px] left-0 top-0 w-[448px]" data-name="固定">
      <div className="absolute bottom-0 h-[232px] left-0 pointer-events-none top-0">
        <Frame />
      </div>
      <Component6 />
      <FilterBar />
