import svgPaths from "./svg-cc3fzz67c9";
...
function Container17() {
  return (
    <div className="h-[43.975px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular','Noto_Sans_SC:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#45556c] text-[14px] text-nowrap top-[12.48px] tracking-[-0.1504px]">口碑优先</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="h-[43.975px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#45556c] text-[14px] text-nowrap top-[12.48px] tracking-[-0.1504px]">合格率优先</p>
    </div>
  );
}
