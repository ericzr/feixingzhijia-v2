import svgPaths from "./svg-ifjqtxxbpy";
...
function Text6() {
  return (
    <div className="bg-[#fbf2db] h-[19.978px] relative rounded-[4px] shrink-0 w-[95.211px]" data-name="Text">
      <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[16px] left-[7.99px] not-italic text-[#c99619] text-[12px] text-nowrap top-[2.65px]">综合排行第1名</p>
    </div>
  );
}
