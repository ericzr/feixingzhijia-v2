import svgPaths from "./svg-n6jrurm00k";
...
function Container7() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.6)] h-[17.485px] left-0 rounded-br-[10px] top-[19.97px] w-[56.958px]" data-name="Container">
      <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[13.5px] left-[5.99px] not-italic text-[9px] text-nowrap text-white top-[1.73px] tracking-[0.167px]">规范化教学</p>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11.994px] h-[346px] items-start left-0 px-[15.996px] py-0 top-[472px] w-[448px]" data-name="Container">
      <ClassCard />
      <ClassCard1 />
      <ClassCard2 />
    </div>
...
function Container32() {
  return (
    <div className="absolute bg-white h-[68px] left-0 top-0 w-[448px]" data-name="Container">
      <Button5 />
      <Heading />
      <Container31 />
    </div>
...
function Container89() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[15.996px] h-[237px] items-start left-0 pb-0 pt-[23.988px] px-0 top-[946px] w-[448px]" data-name="Container">
      <Container59 />
      <Container88 />
    </div>
  );
...
function Container123() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[23.988px] h-[581px] items-start left-0 pb-0 pt-[23.988px] px-[15.996px] top-[1183px] w-[448px]" data-name="Container">
      <Container90 />
      <Container99 />
      <Container102 />
      <Container103 />
...
function Text38() {
  return (
    <div className="h-[26px] relative shrink-0 w-[60.539px]" data-name="Text">
      <div aria-hidden="true" className="absolute border-[#c99619] border-[0px_0px_2px] border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Text41() {
  return <div className="h-[20px] shrink-0 w-[28px]" data-name="Text" />;
}
...
function Container130() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[11.994px] h-[117px] items-start left-0 pb-0 pt-[16.741px] px-[15.996px] top-[829px] w-[448px]" data-name="Container">
