import svgPaths from "./svg-wrrjx9dyaw";
...
function Text9() {
  return (
    <div className="h-[15.985px] relative shrink-0 w-[47.988px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[16px] left-[24px] not-italic text-[#45556c] text-[12px] text-center text-nowrap top-[0.74px] translate-x-[-50%]">随机练习</p>
      </div>
    </div>
  );
}
