import svgPaths from "./svg-0srjk7gebg";
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11.994px] h-[749px] items-start left-0 px-[15.996px] py-0 top-[672px] w-[448px]" data-name="Container">
      <ClassCard />
      <ClassCard1 />
      <ClassCard2 />
    </div>
...
function Container93() {
  return (
    <div className="absolute left-0 size-[59.994px] top-0" data-name="Container">
      <div className="absolute flex items-center justify-center left-0 size-[59.994px] top-[0.46px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 px-[16px] py-0 top-[487px] w-[448px]">
      <Container128 />
    </div>
  );
}
