import svgPaths from "./svg-1varj07htx";
...
function Heading() {
  return (
    <div className="absolute h-[28px] left-0 top-0 w-[99px]" data-name="Heading 1">
...
function Container25() {
  return (
    <div className="absolute content-stretch flex gap-[3.99px] h-[18.986px] items-center left-[106.99px] top-[4.5px] w-[66.09px]" data-name="Container">
      <Component />
      <Icon4 />
      <Text5 />
    </div>
...
function Container26() {
  return (
    <div className="absolute h-[27.99px] left-0 top-0 w-[321.133px]" data-name="Container">
      <Heading />
      <Container25 />
    </div>
  );
...
function Icon5() {
  return (
    <div className="absolute left-[6.99px] size-[13.995px] top-[7px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9952 13.9952">
        <g clipPath="url(#clip0_1358_2581)" id="Icon">
          <path d={svgPaths.p1df4cc00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16627" />
        </g>
        <defs>
          <clipPath id="clip0_1358_2581">
...
function Button7() {
  return (
    <div className="absolute bg-[#c99619] left-[345px] rounded-[2.49829e+07px] size-[27.99px] top-0" data-name="Button">
      <Icon5 />
    </div>
  );
}
...
function Button12() {
  return (
    <div className="basis-0 bg-[#edc764] grow min-h-px min-w-px relative rounded-[2.49829e+07px] shadow-[0px_1px_3px_0px_rgba(251,242,219,0.1),0px_1px_2px_-1px_rgba(251,242,219,0.1)] shrink-0" data-name="Button">
...
function Icon30() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g clipPath="url(#clip0_1358_2572)" id="Icon">
  ...
  return (
    <div className="basis-0 bg-[#c99619] grow min-h-px min-w-px relative rounded-[2.49829e+07px] shadow-[0px_1px_3px_0px_rgba(251,242,219,0.1),0px_1px_2px_-1px_rgba(251,242,219,0.1)] shrink-0" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center justify-center px-[113px] py-[9px] relative w-full">
          <Icon30 />
          <p className="font-['Inter:Bold','Noto_Sans_SC:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold leading-[22.5px] not-italic relative shrink-0 text-[15px] text-center text-nowrap text-white tracking-[-0.2344px]">电话咨询</p>
        </div>
      </div>
    </div>
  );
