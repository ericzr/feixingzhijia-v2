import svgPaths from "./svg-jamhi0x1lm";
...
function Text8() {
  return (
    <div className="absolute h-[22.488px] left-[25.99px] top-0 w-[59.983px]" data-name="Text">
      <p className="absolute font-['Inter:Bold','Noto_Sans_SC:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold leading-[22.5px] left-0 not-italic text-[#1d293d] text-[15px] text-nowrap top-[-0.77px] tracking-[-0.2344px]">速记口诀</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-gradient-to-b from-[#fadb14] h-[27.967px] relative rounded-[2.49829e+07px] shadow-[0px_1px_3px_0px_#ffedd4,0px_1px_2px_-1px_#ffedd4] shrink-0 to-[#faad14] w-[132.634px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Text11 />
        <p className="absolute font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[16px] left-[80.02px] not-italic text-[#7b3306] text-[12px] text-center text-nowrap top-[6.74px] translate-x-[-50%]">{`查看完整口诀 >`}</p>
      </div>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[23.988px] h-[984px] items-start left-0 overflow-clip pb-0 pt-[23.988px] px-[15.996px] top-[105px] w-[448px]" data-name="Container">
      <Container />
      <Container4 />
      <Container17 />
    </div>
...
function Text13() {
  return (
    <div className="h-[25.489px] relative shrink-0 w-[129.656px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[25.5px] left-0 not-italic text-[#1d293d] text-[17px] top-[0.23px] tracking-[-0.4316px] w-[130px]">剩余时间 120:00</p>
      </div>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-[#fefbf4] relative size-full" data-name="模拟考试">
      <Container18 />
