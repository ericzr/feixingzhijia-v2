import svgPaths from "./svg-fsceln6xtq";
    ...
    <div className="bg-[rgba(255,251,242,0.5)] h-[43.975px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[16px] py-[12px] relative size-full">
          <p className="font-['Inter:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#c99619] text-[14px] text-nowrap tracking-[-0.1504px]">智能排序</p>
        </div>
      </div>
    </div>
  );
...
function Container16() {
  return (
    <div className="h-[43.975px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#45556c] text-[14px] text-nowrap top-[12.48px] tracking-[-0.1504px]">距离优先</p>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="h-[43.975px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#45556c] text-[14px] text-nowrap top-[12.48px] tracking-[-0.1504px]">口碑优先</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="h-[43.975px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[20px] left-[16px] not-italic text-[#45556c] text-[14px] text-nowrap top-[12.48px] tracking-[-0.1504px]">通过率优先</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[191.884px] items-start pb-0 pt-[7.992px] px-0 relative shrink-0 w-full" data-name="Container">
      <Container15 />
      <Container16 />
      <Container17 />
      <Container18 />
...
function Text20() {
  return (
    <div className="h-[19.986px] relative shrink-0 w-[55.992px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[14px] text-black text-nowrap top-[0.49px] tracking-[-0.1504px]">智能排序</p>
      </div>
    </div>
  );
}
...
function Tre() {
  return (
    <div className="absolute content-stretch flex flex-col h-[76px] items-start left-0 top-[156px] w-[448px]" data-name="tre">
      <Container27 />
    </div>
  );
}
