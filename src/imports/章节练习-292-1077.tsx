import svgPaths from "./svg-mclhiw6gyp";
...
function Heading() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-[48px] px-[116px] py-0 top-[12px] w-[349px]" data-name="Heading 1">
      <p className="font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[28px] not-italic relative shrink-0 text-[#1d293d] text-[18px] text-center text-nowrap tracking-[-0.4395px]">章节练习</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute bg-[#fbe6db] h-[27.967px] left-[280.02px] rounded-[2.49829e+07px] top-[5.5px] w-[79.981px]" data-name="Button">
      <p className="absolute font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[16px] left-[40px] not-italic text-[#c97419] text-[12px] text-center text-nowrap top-[6.74px] translate-x-[-50%]">随机练习</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="absolute bg-[#fbe6db] h-[27.967px] left-[280px] rounded-[2.49829e+07px] top-[5.5px] w-[79.981px]" data-name="Button">
      <p className="absolute font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[16px] left-[40px] not-italic text-[#c97419] text-[12px] text-center text-nowrap top-[6.74px] translate-x-[-50%]">随机练习</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="h-[16.997px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[17px] left-0 not-italic text-[#1d293d] text-[17px] text-nowrap top-[-0.23px] tracking-[-0.4316px]">系统组成</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="h-[16.997px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[17px] left-0 not-italic text-[#1d293d] text-[17px] text-nowrap top-[-0.23px] tracking-[-0.4316px]">任务规划</p>
    </div>
  );
}
