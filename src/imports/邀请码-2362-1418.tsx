import svgPaths from "./svg-h2kuzsznbs";
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col h-[81px] items-start pb-0 pt-[16.656px] px-0 relative shrink-0 w-full" data-name="Container">
