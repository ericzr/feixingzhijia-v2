import svgPaths from "./svg-tf2ab1r716";
...
function Container16() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.6)] h-[17.485px] left-0 rounded-br-[10px] top-[19.97px] w-[65.951px]" data-name="Container">
      <p className="absolute font-['Inter:Regular','Noto_Sans_SC:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[13.5px] left-[5.99px] not-italic text-[9px] text-nowrap text-white top-[1.73px] tracking-[0.167px]">专业教练团队</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="h-[22.488px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[22.5px] left-0 not-italic text-[#1d293d] text-[15px] text-nowrap top-[-0.77px] tracking-[-0.2344px]">B2 VIP班-超视距驾驶</p>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11.994px] h-[749px] items-start left-0 px-[15.996px] py-0 top-[472px] w-[448px]" data-name="Container">
      <ClassCard />
      <ClassCard1 />
      <ClassCard2 />
    </div>
...
function SchoolProfile() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-0 px-[59px] py-0 top-[416px] w-[448px]" data-name="SchoolProfile">
      <Button3 />
      <Button4 />
    </div>
  );
...
function ImageWithFallback3() {
  return <div className="absolute h-[301px] left-0 top-[-45px] w-[448px]" data-name="ImageWithFallback" />;
}
...
function Button5() {
  return (
    <button className="bg-[rgba(0,0,0,0)] cursor-pointer relative rounded-[2.49829e+07px] shrink-0 size-[35.994px]" data-name="Button">
...
function Container32() {
  return (
    <div className="absolute bg-white content-stretch flex h-[68px] items-center justify-between left-0 px-[15.996px] py-0 top-0 w-[448px]" data-name="Container">
      <Button5 />
      <Heading />
      <Container31 />
    </div>
...
function Container33() {
  return (
    <div className="absolute bg-white h-[52px] left-0 top-[40px] w-[448px]" data-name="Container">
      <ImageWithFallback3 />
      <Container32 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[11.994px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.9942 11.9942">
        <g clipPath="url(#clip0_359_893)" id="Icon">
  ...
  return (
    <div className="relative shrink-0 size-[15.996px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9962 15.9962">
        <g clipPath="url(#clip0_359_887)" id="Icon">
...
function Icon8() {
  return (
    <div className="relative shrink-0 size-[17.997px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9971 17.9971">
        <g clipPath="url(#clip0_359_882)" id="Icon">
...
function Icon9() {
  return (
    <div className="relative shrink-0 size-[11.994px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11.9942 11.9942">
        <g clipPath="url(#clip0_359_877)" id="Icon">
...
function Container56() {
  return (
    <div className="absolute h-[256px] left-0 top-[157px] w-[448px]" data-name="Container">
      <Container52 />
      <Container55 />
    </div>
  );
  ...
  return (
    <div className="absolute left-[5.99px] size-[7.992px] top-[4.75px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.99226 7.99226">
        <g clipPath="url(#clip0_359_921)" id="Icon">
...
function Icon15() {
  return (
    <div className="absolute left-[5.99px] size-[7.992px] top-[4.75px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.99226 7.99226">
        <g clipPath="url(#clip0_359_874)" id="Icon">
...
function Icon16() {
  return (
    <div className="absolute left-[5.99px] size-[7.992px] top-[4.75px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.99226 7.99226">
        <g clipPath="url(#clip0_359_900)" id="Icon">
  ...
  return (
    <div className="absolute left-0 size-[9.993px] top-[3.26px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.99323 9.99323">
        <g clipPath="url(#clip0_359_870)" id="Icon">
          <g id="Vector">
...
function Icon21() {
  return (
    <div className="absolute left-0 size-[9.993px] top-[3.26px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.99323 9.99323">
        <g clipPath="url(#clip0_359_917)" id="Icon">
          <g id="Vector">
...
function Icon23() {
  return (
    <div className="absolute left-0 size-[9.993px] top-[3.26px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.99323 9.99323">
        <g clipPath="url(#clip0_359_927)" id="Icon">
          <g id="Vector">
...
function Icon26() {
  return (
    <div className="relative shrink-0 size-[13.995px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9952 13.9952">
        <g clipPath="url(#clip0_359_862)" id="Icon">
...
function Text38() {
  return (
    <div className="h-[26px] relative shrink-0 w-[60.539px]" data-name="Text">
      <div aria-hidden="true" className="absolute border-[#0f172b] border-[0px_0px_2px] border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[20px] left-0 not-italic text-[#0f172b] text-[14px] text-nowrap top-[0.5px] tracking-[-0.1504px]">班型/场地</p>
      </div>
    </div>
  );
}
...
function Text39() {
  return (
    <div className="h-[20px] relative shrink-0 w-[28px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#62748e] text-[14px] text-nowrap top-[0.5px] tracking-[-0.1504px]">教练</p>
      </div>
    </div>
  );
}
...
function Text40() {
  return (
    <div className="h-[20px] relative shrink-0 w-[28px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular','Noto_Sans_SC:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#62748e] text-[14px] text-nowrap top-[0.5px] tracking-[-0.1504px]">评价</p>
      </div>
    </div>
  );
}
...
function Text41() {
  return (
    <div className="h-[20px] relative shrink-0 w-[28px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#62748e] text-[14px] text-nowrap top-[0.5px] tracking-[-0.1504px]">推荐</p>
      </div>
    </div>
  );
}
...
function Container124() {
  return (
    <div className="content-stretch flex gap-[24px] h-[50px] items-center relative shrink-0 w-full" data-name="Container">
      <Text38 />
      <Text39 />
      <Text40 />
      <Text41 />
...
function Container125() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[51px] items-start left-0 pb-px pt-0 px-[16px] top-[95px] w-[448px]" data-name="Container">
...
function Icon28() {
  return (
    <div className="relative shrink-0 size-[19.998px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.9981 19.9981">
        <g clipPath="url(#clip0_359_858)" id="Icon">
...
function Text42() {
  return (
    <div className="h-[15.007px] relative shrink-0 w-[20.01px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[15px] left-[10.5px] not-italic text-[#45556c] text-[10px] text-center text-nowrap top-[0.49px] tracking-[0.1172px] translate-x-[-50%]">咨询</p>
      </div>
    </div>
  );
}
...
function Icon29() {
  return (
    <div className="relative shrink-0 size-[17.997px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9971 17.9971">
        <g clipPath="url(#clip0_359_855)" id="Icon">
...
export default function Component1() {
  return (
    <div className="bg-[#fefbf4] relative size-full" data-name="飞场详情-下滑变体">
      <SchoolProfile1 />
      <Container29 />
      <SchoolProfile />
      <Container33 />
