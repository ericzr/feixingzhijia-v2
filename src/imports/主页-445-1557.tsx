import svgPaths from "./svg-2d31pqs3kw";
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center left-0 shadow-[0px_1px_3px_0px_rgba(251,242,219,0.1),0px_1px_2px_-1px_rgba(251,242,219,0.1)] top-[232px] w-[446px]">
      <Container14 />
      <Frame3 />
    </div>
  );
...
export default function Component4() {
  return (
    <div className="relative size-full" data-name="主页" style={{ backgroundImage: "linear-gradient(rgb(255, 255, 255) 11.201%, rgba(251, 242, 219, 0.18) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Component3 />
      <BottomNav />
      <Frame5 />
    </div>
