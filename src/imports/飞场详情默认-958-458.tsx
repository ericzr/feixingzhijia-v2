import svgPaths from "./svg-31gpzzjuw2";
...
function Container45() {
  return (
    <div className="absolute h-[65px] left-[0.01px] overflow-clip top-0 w-[217px]" data-name="Container">
      <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_KR:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[17.875px] left-0 not-italic text-[#6a7282] text-[13px] top-[-0.26px] tracking-[-0.0762px] w-[170px]">内蒙古自治区鄂尔多斯市东胜区交通街道伊化北路祥...</p>
    </div>
  );
}
