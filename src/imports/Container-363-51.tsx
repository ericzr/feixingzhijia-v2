import svgPaths from "./svg-pd3wpajcj6";
...
function Text2() {
  return (
    <div className="absolute h-[15.987px] left-[112.61px] top-[2.01px] w-[48.969px]" data-name="Text">
      <p className="absolute font-['Inter:Regular','Noto_Sans_SC:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[16px] left-0 not-italic text-[#99a1af] text-[12px] text-nowrap top-[0.66px]">15条评价</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[15.987px] relative shrink-0 w-[35.996px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid font-normal leading-[16px] not-italic relative size-full text-[#99a1af] text-[12px] text-nowrap">
        <p className="absolute font-['Inter:Regular','Noto_Sans_SC:Regular','Noto_Sans_JP:Regular','Noto_Sans_KR:Regular',sans-serif] left-[66.09px] top-[0.65px]">{`东胜区   3.3 km`}</p>
  ...
  return (
    <div className="bg-white relative rounded-[10px] size-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[11.995px] items-center overflow-clip pb-[12px] pt-[11.995px] px-[11.995px] relative size-full">
          <Image />
          <Container5 />
        </div>
      </div>
