import svgPaths from "./svg-2osac0wyph";
...
function Text1() {
  return (
    <div className="h-[22.488px] relative shrink-0 w-[134.216px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[22.5px] left-0 not-italic text-[#314158] text-[15px] text-nowrap top-[-0.77px] tracking-[-0.2344px]">预测考试通过率</p>
        <Text />
      </div>
    </div>
  );
...
function Text3() {
  return (
    <div className="h-[15.985px] relative shrink-0 w-[107.04px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular','Noto_Sans_SC:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[16px] left-[53.52px] not-italic text-[#99a1af] text-[12px] text-center text-nowrap top-[0.74px] translate-x-[-50%]">未做题</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[25.489px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold','Noto_Sans_SC:Bold','Noto_Sans_JP:Bold',sans-serif] font-bold leading-[25.5px] left-0 not-italic text-[#1d293d] text-[17px] text-nowrap top-[0.23px] tracking-[-0.4316px]">高效刷题</p>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="h-[15.985px] relative shrink-0 w-[47.988px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[16px] left-[24px] not-italic text-[#45556c] text-[12px] text-center text-nowrap top-[0.74px] translate-x-[-50%]">章节练习</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="h-[15.985px] relative shrink-0 w-[47.988px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[16px] left-[24px] not-italic text-[#45556c] text-[12px] text-center text-nowrap top-[0.74px] translate-x-[-50%]">每日一练</p>
      </div>
    </div>
  );
}
