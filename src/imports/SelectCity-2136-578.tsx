import svgPaths from "./svg-bzr8oy0mrf";
...
function Container() {
  return (
    <div className="absolute content-stretch flex gap-[16px] h-[31.989px] items-center justify-end left-[293px] top-[11.65px] w-[127.968px]" data-name="Container">
      <Button1 />
      <Icon2 />
    </div>
  );
