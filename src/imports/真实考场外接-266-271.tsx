import svgPaths from "./svg-j94gn2c70k";
import img40531765608780Pic from "figma:asset/326848447b1d7edcc4c5247621b1019b860e42fd.png";
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[116px] py-0 relative shrink-0 w-[367px]" data-name="Heading 1">
      <p className="font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[28px] not-italic relative shrink-0 text-[#1d293d] text-[18px] text-center text-nowrap tracking-[-0.4395px]">真实考场</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="真实考场-外接" style={{ backgroundImage: "linear-gradient(rgb(245, 219, 155) 11.201%, rgba(251, 242, 219, 0.18) 100%), linear-gradient(90deg, rgb(254, 251, 244) 0%, rgb(254, 251, 244) 100%)" }}>
      <div className="absolute bottom-0 h-[924px] left-0 pointer-events-none top-0">
        <Frame />
      </div>
      <SelectCity />
      <div className="absolute flex h-[974px] items-center justify-center left-0 top-[-25px] w-[448px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <div className="h-[448px] relative w-[974px]" data-name="40531765608780_.pic">
            <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={img40531765608780Pic} />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0c3468] h-[32px] left-0 top-[-4px] w-[448px]" />
      <div className="absolute bg-[#0c3468] h-[32px] left-0 top-[892px] w-[448px]" />
    </div>
  );
}