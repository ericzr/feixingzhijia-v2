import svgPaths from "./svg-mrcg1ilzcy";
...
function Text2() {
  return (
    <div className="content-stretch flex h-[20.103px] items-center justify-center relative shrink-0 w-[244.375px]" data-name="Text">
      <p className="basis-0 font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium grow leading-[27.625px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d293d] text-[17px] tracking-[-0.4316px]">军用无人机可分为__________。</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="h-[48.721px] relative shrink-0 w-full" data-name="Container">
      <Text3 />
      <p className="absolute font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[24.375px] left-[19.26px] not-italic text-[#314158] text-[15px] top-[-1.02px] tracking-[-0.2344px] w-[319px]">侦察无人机、诱饵无人机、电子对抗无人机、通信中继无人机、无人战斗机以及靶机</p>
    </div>
  );
}
