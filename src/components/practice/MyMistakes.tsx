  ...
  return (
    <div className="relative shrink-0 size-[19.998px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19.9981 19.9981">
        <g clipPath="url(#clip0_293_1425)">
          <path d={svgPaths.p33d61b00} stroke="#C99619" strokeWidth="1.66651" />
          <path d={svgPaths.p17fb81b0} stroke="#C99619" strokeWidth="1.66651" />
          <path d={svgPaths.p3028c500} stroke="#C99619" strokeWidth="1.66651" />
        </g>
        <defs>
...
function MistakeCard({ 
  ...
  return (
    <div className="bg-white flex items-center justify-between px-[16px] h-[74px] rounded-[14px] shadow-[0px_1px_3px_0px_#fbf2db,0px_1px_2px_-1px_#fbf2db] w-[calc(50%-8px)]">
      <div className="flex flex-col gap-[4px]">
        <p className="font-medium text-[#1d293d] text-[15px]">{title}</p>
        <p className="font-normal text-[#99a1af] text-[12px]">{subtitle}</p>
      </div>
      <div className={`flex items-center justify-center size-[40px] rounded-full ${typeof icon === 'object' && 'bg-[#fbf2db]'}`}>
        {/* If icon is ALL, bg is #c99619. If Note, bg is #fbf2db. Logic handled below or passed in. */}
        {icon}
      </div>
    </div>
  );
...
function ChevronRightDark() {
  return (
    <div className="relative shrink-0 size-[16px]">
      <svg className="block size-full" fill="none" viewBox="0 0 16 16">
        <path d={svgPaths.p5fe1780} stroke="#99A1AF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33301" />
      </svg>
    </div>
  );
}
    ...
    return (
        <div className="relative shrink-0 size-[12px]">
            <svg className="block size-full" fill="none" viewBox="0 0 12 12">
                <path d={svgPaths.p31ececc0} stroke="#99A1AF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.999517" />
                <path d={svgPaths.p19e3ee80} stroke="#99A1AF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.999517" />
            </svg>
        </div>
    );
}
...
const mistakeTypes = [
    { id: 1, label: "答错5次以上", count: 0 },
    { id: 2, label: "答错4次", count: 0 },
    { id: 3, label: "答错3次", count: 0 },
    { id: 4, label: "答错2次", count: 0 },
    { id: 5, label: "答错1次", count: 0 },
];
      ...
      <div className="flex-1 overflow-y-auto px-[16px] pt-[20px] pb-[40px] flex flex-col gap-[16px]">
        ...
        <div className="flex items-center justify-between w-full gap-[15px]">
            ...
            <div className="bg-white flex items-center justify-between px-[16px] h-[74px] rounded-[14px] shadow-[0px_1px_3px_0px_#fbf2db,0px_1px_2px_-1px_#fbf2db] flex-1">
                <div className="flex flex-col gap-[4px]">
                    <p className="font-medium text-[#1d293d] text-[15px]">今日错题</p>
                    <p className="font-normal text-[#99a1af] text-[12px]">新增0题</p>
                </div>
                <div className="flex items-center justify-center size-[40px] rounded-full bg-[#fbf2db]">
                    <IconNote />
                </div>
            </div>
            ...
            <div className="bg-white flex items-center justify-between px-[16px] h-[74px] rounded-[14px] shadow-[0px_1px_3px_0px_#fbf2db,0px_1px_2px_-1px_#fbf2db] flex-1">
                <div className="flex flex-col gap-[4px]">
                    <p className="font-medium text-[#1d293d] text-[15px]">全部错题</p>
        ...
        {/* Settings Row */}
        <div className="bg-white h-[54px] rounded-[14px] shadow-[0px_1px_3px_0px_#fbf2db,0px_1px_2px_-1px_#fbf2db] w-full px-[16px] flex items-center justify-between">
            <span className="font-medium text-[#1d293d] text-[15px]">移除设置</span>
            <div className="flex items-center gap-[4px]">
                <span className="text-[#6a7282] text-[13px]">答对不自动移除</span>
                <ChevronRightDark />
            </div>
        </div>
        ...
        <div className="bg-white rounded-[14px] shadow-[0px_1px_3px_0px_#fbf2db,0px_1px_2px_-1px_#fbf2db] w-full p-[16px] min-h-[400px]">
            ...
            <div className="flex items-center justify-between mb-[24px]">
                <div className="flex flex-col gap-[4px]">
                    <span className="font-bold text-[#1d293d] text-[16px]">错题详情</span>
                    <div className="flex items-center gap-[4px]">
                        <IconSync />
                        <span className="text-[#99a1af] text-[12px]">登录后同步错题记录</span>
                    </div>
                </div>
                <div className="bg-[#fbf2db] px-[12px] py-[6px] rounded-full">
                    <span className="text-[#c99619] text-[12px] font-medium">按答错次数分类</span>
                </div>
            </div>
