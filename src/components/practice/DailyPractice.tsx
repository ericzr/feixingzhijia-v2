...
function Header({ onBack }: { onBack: () => void }) {
  return (
    <div className="flex items-center justify-center pt-[50px] pb-3 w-full relative z-10">
      ...
      <p className="font-bold text-[#1d293d] text-[18px] text-center tracking-[-0.44px]">每日一练</p>
    </div>
  );
}
    ...
    <div className="bg-[#fbf2db] flex items-center justify-center relative rounded-full shrink-0 size-[80px]">
      <div className="relative shrink-0 size-[44px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 43.9981 43.9981">
          <path d={svgPaths.p2875b380} stroke="#C99619" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.75" />
          <path d={svgPaths.p40e1300} stroke="#C99619" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.75" />
          <path d={svgPaths.p3e2e1680} stroke="#FBF2DB" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.75" />
        </svg>
      </div>
    </div>
  );
...
function Illustration() {
  return (
    <div className="h-[180px] overflow-clip relative shrink-0 w-full max-w-[240px]">
      ...
      <div className="absolute bottom-[26.67%] left-[42.5%] right-1/2 top-[70%]">
         {/* Seems misaligned in import, but keeping structure */}
         {/* This block is actually hidden or small? */}
      </div>
