  ...
  return (
    <div className="flex flex-col w-full shrink-0 z-50">
       ...
       <div className="bg-white border-[#f3f4f6] border-b-[0.745px] border-solid h-[65px] relative w-full shrink-0">
          ...
          <p className="absolute font-sans font-bold leading-[25.5px] left-[50%] translate-x-[-50%] not-italic text-[#1d293d] text-[17px] text-nowrap top-[19.13px] tracking-[-0.4316px]">顺序练习</p>
